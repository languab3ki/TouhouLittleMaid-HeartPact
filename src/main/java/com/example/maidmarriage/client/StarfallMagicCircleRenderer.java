...
public final class StarfallMagicCircleRenderer extends EntityRenderer<StarfallMagicCircleEntity> {
    private static final ResourceLocation CIRCLE = ResourceLocation.fromNamespaceAndPath(MaidMarriageMod.MOD_ID, "textures/entity/starfall_bagua_full.png");
    private static final ResourceLocation BURST = ResourceLocation.fromNamespaceAndPath(MaidMarriageMod.MOD_ID, "textures/entity/starfall_magic_burst.png");
    ...
    private static void vertex(Matrix4f matrix, VertexConsumer consumer, float x, float z, float u, float v, Color color, float alpha) {
        consumer.addVertex(matrix, x, 0.0F, z)
                .setColor(color.r, color.g, color.b, Mth.clamp(alpha, 0.0F, 1.0F))
                .setUv(u, v)
